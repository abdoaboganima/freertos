/**
 *
 * @file       11_eventGroups_ORingEvents.c
 * @brief      
 * @author     Abdulrahman Aboghanima
 * @date       Tue Oct 18 17:07:34 2022
...
void vPrint(void *pv)
{
  ...
  while(1){
    xEventGroupWaitBits(twoEvents, 
			...
			pdFALSE, /*Wait for any of the flags to happen */
			portMAX_DELAY); /*Make the function indefinitely waits for the two events to happen*/
    
    printf("ONE at least of the two events has happened\n");
  }
}
